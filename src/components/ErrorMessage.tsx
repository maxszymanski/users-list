...
function ErrorMessage() {
    ...
    return (
        <div className="flex flex-col items-center gap-4 border-lightborder pb-8 pt-4 text-lg dark:border-darkborder sm:border-t sm:py-12 lg:gap-8 lg:py-16 lg:text-xl">
            <svg
